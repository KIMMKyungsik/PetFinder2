...
class FindPetFragment : Fragment(), EventListener<QuerySnapshot> {

    private lateinit var binding: FindPetFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = FindPetFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            regesterButton.setOnClickListener {
                ReportActivity.startActivity(this@FindPetFragment, ReportActivity.Companion.PetListType.FIND)
            }
        }
